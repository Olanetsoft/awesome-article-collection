...
| [Building a simple CRUD (create, read, update, delete) application with Laravel](https://mohy.hashnode.dev/building-a-simple-crud-create-read-update-delete-application-with-laravel)  | [Ashimi0x](https://twitter.com/Adebowale1st)           | [Link](https://mohy.hashnode.dev/building-a-simple-crud-create-read-update-delete-application-with-laravel)    | 2023-01-14   | 2 |
| [How to Configure a Laravel Project with a Custom Domain Name on Windows with XAMPP](https://www.freecodecamp.org/news/configure-a-laravel-project-with-custom-domain-name/)  | [Yayah Mohammed](https://twitter.com/devmohy)           | [Link](https://www.freecodecamp.org/news/configure-a-laravel-project-with-custom-domain-name/)    | 2023-02-16   | 6 |
